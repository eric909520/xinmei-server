...
//        String text = aesEncryptCbc("{\"langue\":0,\"type\":0}");
        // ywqDrgm+Nn2t3v4hX9j1zfiiE2XR+c18zlLWOkL7pZU=

//        String text = aesEncryptCbc("{\"langue\":1,\"type\":0}");
        // ju1uuZWrKieZcQQyDSi65YaYOKjqsSH86qxL02rCfLs=

//        String text = aesEncryptCbc("{\"langue\":1}");
        // Y1vP2oRlywqTRzMAHeUn6Q==

//        String text = aesEncryptCbc("{\"langue\":0,\"pageNum\":\"6\",\"pageSize\":\"1\"}");
        // Y1vP2oRlywqTRzMAHeUn6Q==

        String text = aesEncryptCbc("{\"langue\":0,\"id\":10}");
