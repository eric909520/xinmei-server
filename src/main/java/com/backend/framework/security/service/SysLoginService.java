...
import com.backend.common.exception.user.CaptchaException;
import com.backend.common.exception.user.CaptchaExpireException;
...
public class SysLoginService {
    ...
    public String login(LoginInfoVo loginInfoVo) {
        ...
        String uuid = loginInfoVo.getUuid();
